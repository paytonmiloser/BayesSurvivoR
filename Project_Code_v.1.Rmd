...
df_clean$jury <- ifelse(castaways.clean$jury =="TRUE",1,0)




df_clean$game_duration <- castaways.clean$day
table(advantage.clean$advantage_type, advantage.clean$version_season)

df_clean$n_immunitys_possible <- df_clean$n_immunitys_possible <- case_when(
